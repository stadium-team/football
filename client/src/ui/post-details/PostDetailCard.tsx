...
export function PostDetailCard({
  ...
  return (
    <Card className="glass-neon-strong rounded-2xl border-2 border-cyan-400/20 shadow-[0_0_15px_rgba(6,182,212,0.1)] overflow-hidden">
      <div className="p-5 space-y-3">
        {/* Author Header */}
        <div className="flex items-start justify-between gap-4 pb-3 border-b border-cyan-400/20">
          ...
          {isAuthor && (
            <DropdownMenu>
              ...
              >
                <DropdownMenuItem
                  onClick={onUpdate}
                  className="text-foreground hover:bg-cyan-500/20"
                >
        ...
        <div className="space-y-3">
          ...
          {post.mediaType === "image" && post.mediaUrl && (
            <div className="rounded-2xl overflow-hidden border-2 border-cyan-400/20 relative group">
              <img
                src={post.mediaUrl}
                alt="Post media"
