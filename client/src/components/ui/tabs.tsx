...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'glass-subtle inline-flex h-11 items-center justify-center rounded-full p-1.5 text-muted-foreground',
      className
    )}
    {...props}
  />
